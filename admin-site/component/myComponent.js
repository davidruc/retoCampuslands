    ...
    const methods = {
      [namefunction]() {
        ...
        ws.addEventListener("message",(e)=>{
            ...
            const id = item.id; // Obtener el valor del primer campo (id)
            actionsTd.innerHTML = `
                <button id="delete-button-${id}" class="btn btn-danger">x</button>
                <button id="add-button-${id}" class="btn btn-warning">+</button>
            `;
